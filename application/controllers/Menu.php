...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $this->db->insert('user_menu', ['name' => $this->input->post('menuname'), 'menu' => $this->input->post('menu')]);
    ...
    public function menuedit($id)
    {
        ...
        $menucontroller = html_escape($this->input->post('menucontrolleredit', true));

        $this->db->update('user_menu', array('name' => $menuname, 'menu' => $menucontroller), array('id' => $id));
