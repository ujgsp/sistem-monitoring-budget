                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($menu as $m) : ?>
                                        <tr>
                                            ...
                                            <td><?= $m['menu']; ?></td>
                                            <td>
                                                <a href="<?= base_url('menu/menuedit/' . $m['id']); ?>" class="btn btn-primary btn_edit" data-menucontroller="<?= $m['menu']; ?>" data-menuname="<?= $m['name']; ?>">Edit</a>
                                                <a href="<?= base_url('menu/menudelete/' . $m['id']); ?>" class="btn btn-danger btn_delete" data-menuname="<?= $m['name']; ?>">Delete</a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                    <?php endforeach; ?>
            ...
            <form action="<?= base_url('menu'); ?>" method="post">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="menu" name="menu" placeholder="Menu Controller">
                    </div>
                </div>
        ...
        <div class="modal-content">
            ...
            <form method="post" id="form_editRoleModal">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <input type="text" class="form-control" id="menucontrolleredit" name="menucontrolleredit" placeholder="Menu Controller">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
...
<script>
    $(function() {
        ...
        $('.btn_edit').on('click', function(e) {
            ...
            const menucontroller = $(this).data('menucontroller');
            ...
            $('#menucontrolleredit').val(menucontroller);
