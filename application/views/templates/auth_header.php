...
<head>
    ...
    <!-- Font Awesome -->
    <link rel="stylesheet" href="<?php echo base_url('assets/vendor/AdminLTE-3.2.0/') ?>plugins/fontawesome-free/css/all.min.css">
    <!-- icheck bootstrap -->
...
<body class="hold-transition login-page">
    <div class="login-box">
        <div class="login-logo">
            <a href="<?php echo base_url() ?>"><b><?= $this->config->item('config_title'); ?></b></a>
        </div>
        <!-- /.login-logo -->